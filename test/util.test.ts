...
describe('parseHexString', () => {
  ...
  test('byte', () => {
    ...
    expect(slice.input[0]).toBe(0xa5)
    expect(slice.index).toBe(0)
  ...
  test('multi-byte', () => {
    ...
    expect(slice.input[0]).toBe(0xbe)
    expect(slice.input[1]).toBe(0xef)
    expect(slice.input[2]).toBe(0xca)
    expect(slice.input[3]).toBe(0xfe)
    expect(slice.input[4]).toBe(0x45)
    expect(slice.index).toBe(0)
  ...
  test('whitespace-2', () => {
    ...
    expect(slice.input).toBeDefined()
    expect(slice.input.length).toBe(1)
    expect(slice.input[0]).toBe(0xca)
    expect(slice.index).toBe(0)
    expect(slice.end).toBe(1)
  })
})
